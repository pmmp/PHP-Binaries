...
then
    ...
    $SCRIPT -t linux32 -o -j $THREADS -c $EXTRA_FLAGS -f x86
...
then
    ...
    $SCRIPT -t linux64 -o -j $THREADS -c $EXTRA_FLAGS -f x86_64
...
then
    ...
    $SCRIPT -t android-armv6 -j 1 -c -x -s $EXTRA_FLAGS -f arm
...
then
    ...
    $SCRIPT -t android-armv7 -j 1 -c -x -s $EXTRA_FLAGS -f arm
